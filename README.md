...
A Java-based GUI application that provides real-time weather updates using API integration.
...
- ✅ Real-time weather updates (temperature, description, humidity, etc.)
- ✅ Clean and intuitive GUI
- ✅ Input validation for city names or zip codes
- ✅ Error handling for failed API calls or invalid inputs
